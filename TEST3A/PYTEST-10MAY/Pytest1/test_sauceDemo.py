...
class Test_sauceDemo:
    ...
    def teardown_method(self):  
        ...
        self.driver.quit()   
    # başarısız giriş Kullanıcı , ID alanını ve şifre yanlış girer     
...
# Kullanıcının zorunlu alanları boş geçmesi 
   ...
   #Add to cart (ürünü sepete ekle) edip ürünün sepete eklendiğini kontrol etme          
    ...
    # Kullanıcının , ürünün sipariş vermesi
    ...
    # başarılı giriş yapar ardından çıkış yapar.
